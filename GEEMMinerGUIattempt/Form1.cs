...
namespace geemMG
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            addressTb.Text = geemMG.Properties.Settings.Default.savedAddress;
            cpuMiningCheck.Checked = geemMG.Properties.Settings.Default.cpuCb;
            gpuMiningCheck.Checked = geemMG.Properties.Settings.Default.gpuCb;
            hardwareCb.SelectedIndex = geemMG.Properties.Settings.Default.hwType;
            refreshTimeNum.Value = geemMG.Properties.Settings.Default.statsSecs;
            writeLogCheck.Checked = geemMG.Properties.Settings.Default.logCb;
            showCLICheck.Checked = geemMG.Properties.Settings.Default.cliCb;
            minerSelectionCb.SelectedIndex = geemMG.Properties.Settings.Default.minerPreference;
        ...
        private async void writePoolsToList(object sender, DownloadStringCompletedEventArgs e)
        {
            ...
            foreach (string[] poolInfo in poolInfoList)
            {
                if (poolInfo[0] != "" && poolInfo[1] != "")
                {
                    ...
                    entryElement.selectedCb.Checked = geemMG.Properties.Settings.Default.savedPools.Contains(poolInfo[2]);
        ...
        private void AnalyzePoolsByCondition(object sender, EventArgs e)
        {
            ...
            geemMG.Properties.Settings.Default.poolPreference = selectionModeCb.SelectedIndex;
        }
        ...
        private void startBtn_Click(object sender, EventArgs e)
        {
            if (startBtn.Text == "Start mining!")
            {
                ...
                {
                    case "Low End Hardware":
                        chosenPort = ":3331";
                        break;
                    case "Mid Range Hardware":
                        chosenPort = ":3332";
                        break;
                    case "High End Hardware":
                        chosenPort = ":3333";
                        break;
                    default:
                        chosenPort = ":3334";
                 ...
                 if (minerSelectionCb.Text == "XMR-stak")
                {
                    ...
                    minerInfo.FileName = geemMG.Properties.Settings.Default.xmrstakpath; //@"miners\xmr-stak\xmr-stak.exe";
                    ...
                    catch (Exception excep)
                    {
                        ...
                        if (location != "")
                        {
                            ...
                            geemMG.Properties.Settings.Default.xmrstakpath = location;
                            miner.Start();
                        }
                        else
                        {
                ...
                geemMG.Properties.Settings.Default.Save();
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            geemMG.Properties.Settings.Default.savedAddress = addressTb.Text;
        }
        ...
        private void numericUpDown1_ValueChanged(object sender, EventArgs e)
        {
            ...
            geemMG.Properties.Settings.Default.statsSecs = (int)refreshTimeNum.Value;
        }
        ...
        private void minerSelectionCb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            geemMG.Properties.Settings.Default.minerPreference = minerSelectionCb.SelectedIndex;
        }
        ...
        {
            geemMG.Properties.Settings.Default.cpuCb = cpuMiningCheck.Checked;
        }

        private void gpuMiningCheck_CheckedChanged(object sender, EventArgs e)
        {
            geemMG.Properties.Settings.Default.gpuCb = gpuMiningCheck.Checked;
        }

        private void hardwareCb_SelectedIndexChanged(object sender, EventArgs e)
        {
            geemMG.Properties.Settings.Default.hwType = hardwareCb.SelectedIndex;
        }

        private void writeLogCheck_CheckedChanged(object sender, EventArgs e)
        {
            geemMG.Properties.Settings.Default.logCb = writeLogCheck.Checked;
        }

        private void showCLICheck_CheckedChanged(object sender, EventArgs e)
        {
            geemMG.Properties.Settings.Default.cliCb = showCLICheck.Checked;
        }
        ...
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            geemMG.Properties.Settings.Default.savedPools = "";
            geemMG.Properties.Settings.Default.savedAddress = "";
            geemMG.Properties.Settings.Default.cpuCb = true;
            geemMG.Properties.Settings.Default.nvCb = false;
            geemMG.Properties.Settings.Default.amdCb = false;
            geemMG.Properties.Settings.Default.gpuCb = true;
            geemMG.Properties.Settings.Default.cpuPerc = 100;
            geemMG.Properties.Settings.Default.hwType = 0;
            geemMG.Properties.Settings.Default.statsSecs = 10;
            geemMG.Properties.Settings.Default.logCb = false;
            geemMG.Properties.Settings.Default.cliCb = false;
            geemMG.Properties.Settings.Default.minerPreference = 0;
            geemMG.Properties.Settings.Default.poolPreference = 0;
            geemMG.Properties.Settings.Default.xmrstakpath = @"miners\xmr-stak\xmr-stak.exe";
            ...
            showCLICheck.Checked = geemMG.Properties.Settings.Default.cliCb;
            minerSelectionCb.SelectedIndex = geemMG.Properties.Settings.Default.minerPreference;
            selectionModeCb.SelectedIndex = geemMG.Properties.Settings.Default.poolPreference;
