...
namespace geemMG
{
    public partial class PoolEntry : UserControl
    {
             ...
             try
                {
                    ...
                    payoutLbl.Text = payout.ToString() + " GEEM";
        ...
        {
            if (selectedCb.Checked && !geemMG.Properties.Settings.Default.savedPools.Contains(miningAddress))
                geemMG.Properties.Settings.Default.savedPools += miningAddress;
            else if (!selectedCb.Checked)
                geemMG.Properties.Settings.Default.savedPools = geemMG.Properties.Settings.Default.savedPools.Replace(miningAddress, "");
        }
    }
}
